...
const BOTNAME = 'TOXIC-BOT|-WA-BOT™';
const FOOTERNAME = '> TOXIC-BOT -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '254719485000' ;  // ADD YOUR NUMBER WITHOUT +
...
OWNER_NAME: process.env.OWNER_NAME || 'TOXIC-BOT' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 TOXIC-BOT -  ＭＤ - Ｖ5 👨‍💻',    
